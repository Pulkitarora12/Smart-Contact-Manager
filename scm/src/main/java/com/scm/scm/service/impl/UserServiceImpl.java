...
public class UserServiceImpl implements UserService {
    ...
    public User saveUser(User user) {
        ...
        User saveUser = pageRepository.save(user); 

        emailService.sendEmail("pulkitpulkitarr@gmail.com", "Verify Account : Email Contact Manager", emailLink);
    ...
    public User getUserByEmail(String email) {
        return pageRepository.findByEmail(email).orElse(null);
    }

    @Override
    public User getUserByEmailToken(String token) {
        
        return pageRepository.findByEmailToken(token).orElse(null);
    }
